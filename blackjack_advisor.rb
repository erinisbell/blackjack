...
pair = {
	...
	"3"   => { "2" =>  p,  "3" =>  p,  "4" =>  p,  "5" =>  p,  "6" =>  p,  "7" =>  p,  "8" =>  p,  "9" =>  h,  "10" =>  h,  "A" =>  h},
	"4"   => { "2" =>  h,  "3" =>  h,  "4" =>  p,  "5" =>  p,  "6" =>  p,  "7" =>  h,  "8" =>  h,  "9" =>  h,  "10" =>  h,  "A" =>  h},
	"5"   => { "2" => dh,  "3" => dh,  "4" => dh,  "5" => dh,  "6" => dh,  "7" => dh,  "8" => dh,  "9" => dh,  "10" =>  h,  "A" =>  h},
	"6"   => { "2" =>  p,  "3" =>  p,  "4" =>  p,  "5" =>  p,  "6" =>  p,  "7" =>  p,  "8" =>  h,  "9" =>  h,  "10" =>  h,  "A" =>  h},
	"7"   => { "2" =>  p,  "3" =>  p,  "4" =>  p,  "5" =>  p,  "6" =>  p,  "7" =>  p,  "8" =>  p,  "9" =>  h,  "10" =>  s,  "A" =>  h},
...
first_card = gets.chomp.to_s
puts "What is your second card?"
second_card = gets.chomp.to_s 
puts "Please Enter the Dealer's Card"
dealer_card = gets.chomp.to_s
